"""Source Body Extractor — extract function/class bodies from source files.

Phase B of the rebuild pipeline: attaches runnable code and derives a
``made_of`` dependency graph from call-site analysis.
"""
