...
Every RG_LOOP=47 steps, pending contributions are batched and sent to
nexus.lora_contribute(). This is the flywheel: each user's session
...
# UEP CODEX invariant: RG_LOOP = 47 (ratchet epoch interval)
RG_LOOP = 47
...
class LoRAFlywheel:
    ...
    def __init__(
        ...
        self._batch_interval = int(cfg.get("batch_interval", RG_LOOP))
