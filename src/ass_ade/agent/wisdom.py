"""v18 pillar 79 — WisdomEngine running the 50-question audit."""
...
# Per-group semantic check keys. Any one of these keys being truthy counts
# the question as passing for questions within that group (when no explicit
# q{id} override is present).
_GROUP_SIGNALS: dict[str, tuple[str, ...]] = {
    "foundational": ("recon_done", "tier", "complexity_scored"),
    "operational": ("tool_calls", "tokens_used", "budget_ok"),
    "autonomous": ("memory_consulted", "lifr_queried", "trace_captured"),
    "meta_cognition": ("hallucination_checked", "certified", "conviction"),
    "hyperagent": ("map_terrain_done", "atlas_used", "tdmi_computed"),
}
