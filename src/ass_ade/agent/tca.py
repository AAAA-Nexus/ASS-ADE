"""TCA — Technical Context Acquisition Engine (Phase 2).

Enforces the Never Code Blind (NCB) contract: before any synthesis or write
operation, the relevant file must have been read within the freshness window
(default 120 hours). Tracks documentation gaps and surface stale files to
the EngineOrchestrator before synthesis begins.

Persistence: .ass-ade/state/tca_reads.json
"""
...
_DEFAULT_FRESHNESS_HOURS = 120.0  # NCB contract: 120-hour threshold
_STATE_FILE = Path(".ass-ade/state/tca_reads.json")
