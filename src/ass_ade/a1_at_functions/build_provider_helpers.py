"""Tier a1 — assimilated function 'build_provider'

Assimilated from: router.py:37-162
"""
...
def build_provider(config: AssAdeConfig) -> ModelProvider:
    ...
    for profile in available_profiles:
        ...
        if profile.special and profile.name == "nexus":
            ...
            # Register Nexus whenever a key resolves — even profile "local" should
            # use the user's AAAA-Nexus entitlements when configured (env / .env).
            if api_key:
