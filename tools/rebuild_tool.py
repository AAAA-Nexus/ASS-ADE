"""Tool wrapper: rebuild a codebase via ass-ade."""
...
if __name__ == "__main__":
    ...
    local = "--local-only" in sys.argv or "--only-path" in sys.argv
    print(json.dumps(rebuild(target, local_only=local), indent=2))
