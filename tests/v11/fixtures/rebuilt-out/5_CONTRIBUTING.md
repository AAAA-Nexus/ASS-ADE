...
If a rebuild emitted `TEST_COVERAGE.md`, `DOC_COVERAGE.md`, or `API_INVENTORY.md`,
refresh them by re-running `ass-ade rebuild` so documentation and baseline
verification stay aligned with the shipped package surface.

If a rebuild emitted `MULTILANG_BRIDGES.md`, keep the `bridges/` folder and
`.ass-ade/bridges/bridge_manifest.json` in sync with the shipped Python surface
by regenerating them through `ass-ade rebuild` rather than hand-editing them in place.
...
This folder was built from `C:\!atomadic\ass-ade-v1.1\tests\fixtures\minimal_pkg` · rebuild `20260422_232614` · 2026-04-22.
