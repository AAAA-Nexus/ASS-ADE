...
from ass_ade.ade.staging_handoff import build_staging_handoff_summary
    ...
    _write(
        ...
        "\n".join(
            [
                ...
                "",
                "[project.scripts]",
                'ass-ade = "ass_ade.a4_sy_orchestration.unified_cli:main"',
                'atomadic = "ass_ade.a4_sy_orchestration.unified_cli:main"',
                "",
            ]
        ),
    )
