...
class TestNexusAsProvider:
    ...
    def test_nexus_defaults_to_falcon_10b_across_tiers(self):
        profile = get_provider("nexus")
        assert profile.models_by_tier["fast"] == "falcon3-10B-1.58"
        assert profile.models_by_tier["balanced"] == "falcon3-10B-1.58"
        assert profile.models_by_tier["deep"] == "falcon3-10B-1.58"
    ...
    def test_nexus_selectable_via_tier_policy(self, monkeypatch):
        ...
        assert decision.model == "falcon3-10B-1.58"
