...
from ass_ade.a1_at_functions import body_extractor as be
from ass_ade.a0_qk_constants.exclude_dirs import MAX_FILE_BYTES
...
from ass_ade.a1_at_functions.gap_fill import (
...
def test_gap_fill_kind_branches_and_default_component() -> None:
    from ass_ade.a1_at_functions import gap_fill as gf
...
def test_build_gap_fill_dedup_sibling_branches_and_blueprint_assess() -> None:
    ...
    from ass_ade.a1_at_functions.gap_fill import ProposedComponent, _match_blueprint
...
def test_assess_blueprint_components_variants() -> None:
    from ass_ade.a1_at_functions.gap_fill import ProposedComponent
...
def test_match_registry_impl_stem(tmp_path: Path) -> None:
    from ass_ade.a1_at_functions.registry_fingerprint import match_registry_row
...
def test_stable_registry_row_payload_optional_fields() -> None:
    from ass_ade.a1_at_functions.registry_fingerprint import stable_registry_row_payload
