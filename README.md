...
Auto-generated by ASS-ADE rebuild engine · rebuild `20260418_220755` · 2026-04-19
...
|------|-----------|---------|
| `a0_qk_constants` | 106 | Stateless invariants — constants, axioms |
| `a1_at_functions` | 1330 | Pure functions (atoms) |
| `a2_mo_composites` | 855 | Stateful compositions (molecules) |
| `a3_og_features` | 82 | Feature modules (organisms) |
| `a4_sy_orchestration` | 216 | Top-level orchestration (system) |

**Total components:** 2589
